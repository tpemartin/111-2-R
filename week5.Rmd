...
```{r}
timestampAsCharacter |>
  lubridate::ymd_hms() |>
  lubridate::force_tz(tzone="Asia/Taipei") |>
...
```{r}
dplyr::glimpse(attendanceData)
```

```{r}
dataframe2 |>
  googlesheets4::write_sheet(ss="https://docs.google.com/spreadsheets/d/187LRBCzcHCetea9ZsCnWOUFDdXCfVIZx3R2vvPsmh4I/edit#gid=91650247", sheet="new")
```
